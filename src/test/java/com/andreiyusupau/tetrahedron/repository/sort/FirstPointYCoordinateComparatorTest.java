...
class FirstPointYCoordinateComparatorTest {

    private final FirstPointYCoordinateComparator comparator=new FirstPointYCoordinateComparator();

    @Test
    void compareShouldReturnOne(){
        Point firstPointA=new Point(7.0,3.0,3.0);
